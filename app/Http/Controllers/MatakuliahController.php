...
class MatakuliahController extends Controller
{
    public function insert(){
        ...
        // RAW
        $sql = DB::insert("INSERT INTO matakuliahs (kode_mk,nama_mk,created_at,updated_at) VALUES ('FW11', 'Framework',now(),now())");
        dump($sql);
    ...
    public function update(){
        ...
        //RAW
        $sql = DB::update("UPDATE matakuliahs SET nama_mk='Framework Pem.Web',updated_at=now() WHERE id=?",[1]);
        dd($sql);
